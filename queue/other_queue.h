...
struct node {
	...
	char c; 
    int dist;
    int dest;//the minimum distance of node from src
};
...
class Fibonacci_Heap{
    ...
    node* push(int val,int dest ,int dist)
    {
    ...
    Edge top(){
        Edge returnEdge;
        returnEdge.src = mini->key;
        returnEdge.dest = mini->dest;
        returnEdge.weight = mini->dist;
        return returnEdge;
    }
